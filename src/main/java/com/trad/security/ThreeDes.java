...
public class ThreeDes {  
    ...
    public static byte[] hex(String keyWord){  
        byte[] bkeys =  keyWord.getBytes();  
    ...
    public static void main(String[] args) {  
        ...
        byte[] enk = hex("Deskey123_ooobaotai12345");//密钥
        String password = "aaaaabbbbbb";
        System.out.println("加密前的字符串:" + password);  
        byte[] encoded = encryptMode(enk,password.getBytes());  
        System.out.println("加密后的字符串:" + DataConvertUtil.byte2HexString(encoded));  
