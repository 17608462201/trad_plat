...
<form class="layui-form" action="#" method="post">
	...
	<div class="layui-form-item">
		<label class="layui-form-label">公证时间：</label>
		<div class="layui-input-block">
			<input type="text" name="loanNotarizationTime" id="loanNotarizationTime" lay-verify="date" value="${loan.loanNotarizationTime }" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label">公证图上传：</label>
...
<script>
	...
	$('#delImage').on('click', function(){
		if (confirm("确定要删除吗？")==true){
			$.ajax({
	    	     url: "${ctx}/loan/delImage?loanId="+$('#id').val()+"&type=4",
	    	     dataType: "text",
